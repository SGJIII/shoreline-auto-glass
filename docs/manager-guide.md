...
The homepage reviews section displays the Common Ninja reviews widget only. Manage that widget in Common Ninja using component ID `992c7252-797d-48aa-a2b2-3b868ca1c341`. Keep the widget configured to show review text and stars without reviewer photos.
...
Fleet, dealership, and account requests use a Netlify form named `fleet-support`. To have those submissions emailed without asking the customer to send an email from their own device, set up a Netlify Forms email notification:

1. Open the Shoreline site in Netlify.
2. Go to Forms.
3. Open Form notifications.
4. Add an Email notification for `fleet-support`.
5. Send notifications to Shoreline's approved internal recipient address.
